...
protected:
    ...
    // ===================================相对世界系状态构建============================
    Eigen::Vector3d Posi_b0FLUnENU_nENU_init_ForRel;                       // 相对世界系平移
    Eigen::Matrix3d R_nENUb0FLU_init_ForRel;                               // 相对世界系旋转
    Eigen::Matrix3d R_nENUb0RFU_init_ForRel;
